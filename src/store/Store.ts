...
async saveCanvasToVideoWithAudio() {
    await this.saveCanvasToVideoWithAudioWebmMp4();
}
...
async saveCanvasToVideoWithAudioWebmMp4() {
    ...
    // Create an AudioContext only once and reuse it
    ...
    video.play().then(() => {
        ...
        // Ensure the video element is removed after recording
        video.remove();
    }).catch(error => {
